...
public interface Level extends LevelStateSubject {
    ...
    /**
     * Checks if the given renderable is a Power pellet for the level
     *
     * @param renderable
     * @return true, if renderable is a Power pellet for the level
     */
    boolean isPower(Renderable renderable);

    /**
     * set all the ghost in the level to frighted mod, reset timer and counter for frighted mod
     */
    void collectPower();
