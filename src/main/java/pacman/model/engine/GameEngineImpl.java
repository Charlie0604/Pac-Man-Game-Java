...
import pacman.model.factories.Gfactories.*;
...
public class GameEngineImpl implements GameEngine {
    ...
    private RenderableFactoryRegistry getRenderableFactoryRegistry() {
        ...
        renderableFactoryRegistry.registerFactory(RenderableType.BLINKY_GHOST, new BlinkyFactory());
        renderableFactoryRegistry.registerFactory(RenderableType.PINKY_GHOST, new PinkyFactory());
        renderableFactoryRegistry.registerFactory(RenderableType.INKY_GHOST, new InkyFactory());
        renderableFactoryRegistry.registerFactory(RenderableType.CLYDE_GHOST, new ClydeFactory());
